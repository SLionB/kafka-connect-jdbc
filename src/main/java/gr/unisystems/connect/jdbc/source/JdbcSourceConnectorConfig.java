...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final boolean VALIDATE_NON_NULL_DEFAULT = false; // UniSystems change for OS2200
  ...
  private static class TableRecommender implements Recommender {
    ...
    public List<Object> validValues(String name, Map<String, Object> config) {
      ...
      Set<String> whitelistSet  = new HashSet<>( (List<String>) config.get(JdbcSourceConnectorConfig.TABLE_WHITELIST_CONFIG) );  // UniSystems change for OS2200
