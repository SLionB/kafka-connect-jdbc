...
package gr.unisystems.kafka.connect.jdbc.source;
...
import gr.unisystems.kafka.connect.jdbc.source.JdbcSourceConnectorConstants;
...
import gr.unisystems.kafka.connect.jdbc.source.OffsetProtocols;
import gr.unisystems.kafka.connect.jdbc.util.TableId;

import static gr.unisystems.kafka.connect.jdbc.source.JdbcSourceConnectorConfig.NumericMapping;
