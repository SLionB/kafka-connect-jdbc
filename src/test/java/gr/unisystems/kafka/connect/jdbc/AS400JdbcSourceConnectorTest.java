...
import gr.unisystems.kafka.connect.jdbc.AS400JdbcSourceConnector;
import gr.unisystems.kafka.connect.jdbc.dialect.DatabaseDialect;
import gr.unisystems.kafka.connect.jdbc.source.EmbeddedDerby;
...
@PrepareForTest({AS400JdbcSourceConnector.class, DatabaseDialect.class})
@PowerMockIgnore("javax.management.*")
public class AS400JdbcSourceConnectorTest {

  private AS400JdbcSourceConnector connector;
  ...
  @Before
  public void setup() {
    connector = new AS400JdbcSourceConnector();
