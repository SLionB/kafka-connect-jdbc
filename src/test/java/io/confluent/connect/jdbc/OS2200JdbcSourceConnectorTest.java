...
import gr.unisystems.connect.jdbc.source.EmbeddedDerby;
...
@PrepareForTest({OS2200JdbcSourceConnector.class, JdbcUtils.class})
@PowerMockIgnore("javax.management.*")
public class OS2200JdbcSourceConnectorTest {

  private OS2200JdbcSourceConnector connector;
  private EmbeddedDerby db;
  private Map<String, String> connProps;

  @Before
  public void setup() {
    connector = new OS2200JdbcSourceConnector();
